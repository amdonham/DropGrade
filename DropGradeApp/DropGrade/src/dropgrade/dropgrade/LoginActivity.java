    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
    			...
    			String storedPassword = loginDataBaseAdapter.getPassword(password);
    			if (password.equals(storedPassword)){
					Toast.makeText(LoginActivity.this, loginDataBaseAdapter.getUserID(login), Toast.LENGTH_LONG).show();
					Intent ii=new Intent(LoginActivity.this,MainMenuActivity.class);
					ii.putExtra("UID",loginDataBaseAdapter.getUserID(login));
					startActivity(ii);
					finish();
    			}
            ...
            registerbutton.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
            	 ...
            	 else
 				{
 				    ...
 				    loginDataBaseAdapter.insertUserEntry(user, fuser, luser, useremail, pass, repass);
